package com.tora.tutorialmod.block;

import com.tora.tutorialmod.TutorialMod;
import com.tora.tutorialmod.block.custom.SoundBlock;
import com.tora.tutorialmod.item.ModItems;
...
public class ModBlocks {
    ...
    public static final RegistryObject<Block> SAPPHIRE_DOOR = registerBlock("sapphire_door",
            () -> new DoorBlock(
                    BlockBehaviour.Properties.copy(Blocks.IRON_BLOCK).sound(SoundType.AMETHYST).noOcclusion(),
                    BlockSetType.IRON
            )
    );
