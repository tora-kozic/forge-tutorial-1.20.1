package com.tora.tutorialmod.item;

import com.tora.tutorialmod.TutorialMod;
import com.tora.tutorialmod.item.custom.FuelItem;
import com.tora.tutorialmod.item.custom.MetalDetectorItem;
import com.tora.tutorialmod.item.custom.ModArmorItem;
...
public class ModItems {
    ...
    public static final RegistryObject<Item> PINE_CONE = ITEMS.register("pine_cone",
            () -> new FuelItem(new Item.Properties(), 400)); // 20 ticks per sec
